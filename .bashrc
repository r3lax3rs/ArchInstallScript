...
PS1="${cyan}\342\224\214\342\224\200\$([[ \$? != 0 ]] && echo \"\[\e[38;5;196m\][\342\234\227]\[\e[38;5;87m\]\342\224\200\")${red}[${cyan}${bold}\t${reset}${red}]${gray}\342\224\200${cyan}[${red}${bold}\u${reset}${cyan}]\n${cyan}\342\224\224\342\224\200\342\224\200> ${bold}${cyan}\W${gray} \$ ${bold}${red}>>${reset} ${cyan}"
