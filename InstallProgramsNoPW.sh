...
echo $sudoPW | pacman -Syu --noconfirm
wait
...
#Install Steam
echo $sudoPW | pacman -S steam --needed --noconfirm
#Install Discord
echo $sudoPW | pacman -S discord --needed --noconfirm
#Install Spotify
...
#Install Teamspeak3
echo $sudoPW | pacman -S teamspeak3 --needed --noconfirm
#Install Telegram Desktop App
echo $sudoPW | pacman -S telegram-desktop --needed --noconfirm
#Install Geany (notepad)
echo $sudoPW | pacman -S geany --needed --noconfirm
#Install curl
echo $sudoPW | pacman -S curl --needed --noconfirm
...
echo $sudoPW | mkinitcpio -P
wait
# Unload kernel modules
echo $sudoPW | rmmod wacom hid_uclogic
wait
#Install 1password
